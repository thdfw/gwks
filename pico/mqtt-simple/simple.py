...
class MQTTClient:
    ...
    def connect(self, clean_session=True):
        try:
            ...
            write_in_log(f'Error connecting to MQTT broker ({e})')
            raise e
    ...
    def publish(self, topic, msg, retain=False, qos=0):
        try:
            ...
            write_in_log(f'Error publishing message ({e})')
            raise e
    ...
    def subscribe(self, topic, qos=0):
        ...
        while 1:
            ...
            if op == 0x90:
                ...
                if resp[3] == 0x80:
                    write_in_log(f'Error subscribing to topic ({resp[3]})')
                    raise MQTTException(resp[3])
                return
